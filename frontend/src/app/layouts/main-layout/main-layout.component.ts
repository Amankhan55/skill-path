            ...
            <div class="hidden md:flex items-center space-x-4">
              ...
              @if (authService.isAuthenticated()) {
                <a
                  ...
                  class="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg font-medium"
                >
                  Dashboard
                </a>
              } @else {
                <a
                  routerLink="/login"
                  class="px-4 py-2 text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors"
                >
                  Sign In
                </a>
                <a
